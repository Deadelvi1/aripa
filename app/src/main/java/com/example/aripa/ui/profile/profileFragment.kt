...
class profileFragment : AppCompatActivity() { // <--- Pastikan nama kelas diawali huruf kapital: Page4Activity
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fragment_profile) // <--- KOREKSI INI
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.labelGmail)) { v, insets -> // <--- KOREKSI INI
